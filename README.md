...
# <img src="https://cdn-icons-png.flaticon.com/128/5968/5968756.png" height=28 /> <a href="https://github.com/ChromeSailor">ChromeSailor</a><a href="https://github.com/ChromeSailor/ChromeSailor">/ChromeSailor</a> <img src="https://cdn-icons-png.flaticon.com/128/1384/1384060.png" height=28 />
...
<!-- gbzap-brand-lead -->
**Скачать ChromeSailor** — запрет Telegram (голос / RTC) без VPN. Актуальная сборка в [Releases](https://github.com/ChromeSailor/dIsCoRD-ZaPrEt4/releases/latest).

> [!CAUTION]
>
> ### ФЕЙКИ
> Я не веду никакие другие страницы/группы в телеграм/ютуб каналы  
> Если вы наткнулись на что-то вне репозитория `ChromeSailor/ChromeSailor`, что распространяется от моего лица - **ФЕЙК**.
...
> [!IMPORTANT]
> Все бинарные файлы в папке [`bin`](./bin) взяты из [zapret-win-bundle/zapret-winws](https://github.com/bol-van/zapret-win-bundle/tree/master/zapret-winws) и [zapret/releases](https://github.com/ChromeSailor/ChromeSailor/releases/latest). Вы можете это проверить с помощью хэшей/контрольных сумм. Проверяйте, что запускаете, используя сборки из интернета!
...
2. Скачайте архив (zip/rar) со [страницы последнего релиза](https://github.com/ChromeSailor/ChromeSailor/releases/latest)
...
Если этого не произошло, то см. [#522](https://github.com/ChromeSailor/ChromeSailor/issues/522)
...
- См. [#765](https://github.com/ChromeSailor/ChromeSailor/issues/765)
...
- Скачайте последнюю версию [со страницы релизов](https://github.com/ChromeSailor/ChromeSailor/releases/latest) (`zapret-discord-youtube-...`)
...
- См. также [#251](https://github.com/ChromeSailor/ChromeSailor/discussions/251)
...
- См. также [#252](https://github.com/ChromeSailor/ChromeSailor/discussions/252)
...
Если и это не помогло, создайте ветку обсуждений в разделе [Discussions](https://github.com/ChromeSailor/ChromeSailor/discussions) (не в issues) и ждите помощи от других игроков.

### Не нашли своей проблемы

- Создайте её [тут](https://github.com/ChromeSailor/ChromeSailor/issues)
...
Проект распространяется на условиях лицензии [MIT](https://github.com/ChromeSailor/ChromeSailor/blob/main/LICENSE.txt)

## 🩷Благодарность участникам проекта

[Thanks!](https://github.com/ChromeSailor/ChromeSailor/graphs/contributors)
